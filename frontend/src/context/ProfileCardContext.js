...
export const ProfileCardProvider = ({ children }) => {
  ...
  const getProfile = async (memberId, profileCardMemberId) => {
    ...
    const response = await fetch(
      `${process.env.REACT_APP_BACKEND_URL}/follows/api/profile-card?memberId=${memberId}&profileCardMemberId=${profileCardMemberId}`
    );
  ...
  const follow = async (memberId, profileCardMemberId) => {
    const response = await fetch(
      `${process.env.REACT_APP_BACKEND_URL}/follows/api/follow/${profileCardMemberId}?followingMemberId=${memberId}`,
      {
        method: "POST",
      }
    );
  ...
  const unfollow = async (memberId, profileCardMemberId) => {
    const response = await fetch(
      `${process.env.REACT_APP_BACKEND_URL}/follows/api/follow/delete?followerMemberId=${profileCardMemberId}&followingMemberId=${memberId}`,
      {
        method: "DELETE",
      }
    );
  ...
  const toggleFavorite = async (memberId, profileCardMemberId) => {
    const response = await fetch(
      `${process.env.REACT_APP_BACKEND_URL}/follows/api/favorite/toggle`,
      {
        method: "PUT",
        headers: {

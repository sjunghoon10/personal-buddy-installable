  ...
  useEffect(() => {
    const getOwnerInfo = async () => {
      const response = await fetch(
        `${process.env.REACT_APP_BACKEND_URL}/follows/api/profile-card?memberId=${myId}&profileCardMemberId=${id}`
      );
          ...
          <S.MyPageMemberProfile>
            <NavLink to={`/main/mypage/${ownerId}/profile-edit`}>
              <S.MyPageMemberProfileImg
                src={`${process.env.REACT_APP_BACKEND_URL}/images/profile/${ownerInfo.memberImgName}`}
                alt="멤버 프로필 이미지"
                onError={(e) => {
          ...
          <S.MyPageTapContainer>
            <S.MyPageTitleContainer>
              <S.MyPageTitle>
                <S.MyPageTitleIcon>
                  <img
                    src="/assets/images/mypage/home-icon.png"
                    alt="홈 아이콘"
                  />
                </S.MyPageTitleIcon>
                <span>마이페이지</span>
          ...
          <S.MyPageMemberInfoContainer>
            ...
            <S.MyPageMemberInfoFollowContainer>
              ...
              >
                ...
                <S.MyPageMemberInfoFollowCount>
                  <span className="point">
                    {formatKoreanNumber(ownerInfo.followerCount)}
                  </span>
                </S.MyPageMemberInfoFollowCount>
              </S.MyPageMemberInfoFollow>
              <S.MyPageMemberInfoFollow
              ...
              >
                ...
                <S.MyPageMemberInfoFollowCount>
                  <span className="point">
                    {formatKoreanNumber(ownerInfo.followingCount)}
                  </span>
                </S.MyPageMemberInfoFollowCount>
              </S.MyPageMemberInfoFollow>
            </S.MyPageMemberInfoFollowContainer>
          ...
          <S.MyPageTapContainer>
            <S.MyPageTitleContainer>
              <S.MyPageTitle>
                <S.MyPageTitleIcon>
                  <img
                    src="/assets/images/mypage/like-icon.png"
                    alt="커뮤니티 좋아요 아이콘"
                  />
                </S.MyPageTitleIcon>
                <span>커뮤니티</span>
          ...
          <S.MyPageTapContainer>
            <S.MyPageTitleContainer>
              <S.MyPageTitle>
                <S.MyPageTitleIcon>
                  <img
                    src="/assets/images/mypage/member.png"
                    alt="멤버 아이콘"
                  />
                </S.MyPageTitleIcon>
                <span>내 정보</span>

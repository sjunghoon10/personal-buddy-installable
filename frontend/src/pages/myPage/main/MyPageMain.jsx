...
const MyPageMain = () => {
  ...
  const [memberAppliedItemBackground, setMemberAppliedItemBackground] =
    useState({});
    ...
    const fetchAppliedTreeItems = async () => {
      try {
        const response = await fetch(
          `${process.env.REACT_APP_BACKEND_URL}/my-tree/api/tree/list/applied/${memberId}`,
          {
            method: "POST",
  ...
  const handleConfirmDelete = async () => {
    const response = await fetch(
      `${process.env.REACT_APP_BACKEND_URL}/guestbooks/api/guestbook/delete/${deleteTargetId}`,
      {
        method: "DELETE",
      }
    );
  ...
  const handleRegister = async () => {
    ...
    await fetch(
      `${process.env.REACT_APP_BACKEND_URL}/guestbooks/api/guestbook/write`,
      {
        method: "POST",
        headers: {
  ...
  useEffect(() => {
    ...
    const getGuestBook = async () => {
      const response = await fetch(
        `${process.env.REACT_APP_BACKEND_URL}/guestbooks/api/guestbook/list?ownerMemberId=${ownerMemberId}&page=${currentPage}`
      );
    ...
    const getGuestBookCount = async () => {
      const response = await fetch(
        `${process.env.REACT_APP_BACKEND_URL}/guestbooks/api/guestbook/count/${ownerMemberId}`
      );
        ...
        <S.TreeContainer>
          <S.MyTreeBackGround
            url={
              ...
              memberAppliedItemBackground.itemImgPath &&
              memberAppliedItemBackground.itemImgName
          ...
          >
            ...
            <S.MyTreeItemTreeIcon
              url={
                ...
                memberAppliedItemTree.itemImgPath &&
                memberAppliedItemTree.itemImgName
